...
public class Client implements ActionListener {
    JTextField text;
    static JPanel a1; // Made a1 static
    ...
    Client() {
        ...
        p1.setLayout(null);
        f.add(p1);
        ImageIcon i1 = new ImageIcon("E:\\oop allah vorsha\\chatting-application-master\\chatting-application-master\\Chatting Application\\src\\icons\\3.png");
        ...
        p1.add(video);
        ImageIcon i4 = new ImageIcon("E:\\mine\\profile picture for github.jpg");
